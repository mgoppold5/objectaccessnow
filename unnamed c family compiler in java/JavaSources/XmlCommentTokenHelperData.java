...
public class XmlCommentTokenHelperData extends TokenHelperData {
	// private variables
	// 
	
	// mini states
	static final int STATE_BEGIN_STRING = 21;
	static final int STATE_MIDDLE_SPAN = 22;
	
	static final int STATE_END_HYPHEN1 = 26;
	static final int STATE_END_HYPHEN2 = 27;
	static final int STATE_END_GREATER_THAN = 28;
	...
	public void init() {
		...
		beginString = StringUtils.int32StringFromJavaString(
			Punctuation.PUNCT_XML_COMMENT_START);
