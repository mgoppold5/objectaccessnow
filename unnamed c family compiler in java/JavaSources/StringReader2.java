...
public class StringReader2 implements StringReaderAccess {
	public StringReader2Data dat;
	...
	public void readJavaStringThrow(TextIndex ti, long len) {
		...
		while(iDone < len) {
			...
			if(state == CharReader2Data.STATE_HAVE_CHAR) {
			...
			if(state == CharReader2Data.STATE_END_OF_STREAM)
				throw makeIndexOutOfBoundsException(null);
			
			if(state == CharReader2Data.STATE_HAVE_BAD_CHAR) {
				badCharCount += 1;
