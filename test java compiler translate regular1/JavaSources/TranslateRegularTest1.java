...
public class TranslateRegularTest1 {
	public TranslateRegularTest1Data dat;
	public PrintStream out;
	
	TranslateRegularTest1GrammarData grmrDat;
	TranslateRegularTest1DocData docDat;
	TranslateRegularTest1LogicReadData srcDat;
	TranslateRegularTest1LogicWriteData trgDat;
	...
	public void initTestFile(CommonInt32Array filePath) {
		...
		srcDat = new TranslateRegularTest1LogicReadData();
	...
	public void initTestOutputFile(CommonInt32Array filePath) {
		...
		trgDat = new TranslateRegularTest1LogicWriteData();
	...
	public boolean runTestFile() {
		...
		if(dat.majorPassNum == TranslateRegularTest1Data.PASS_3_WRITE_LOGIC) {
			trgDat.whitespaceState
				= TranslateRegularTest1LogicWriteData.STATE_WAS_NOTHING;
		}
		...
		if(true)
		if(dat.majorPassNum == TranslateRegularTest1Data.PASS_1_COLLECT_NAMES)
		if(!isError) {
	...
	private boolean writeToken2(Symbol sym) {
		...
		if(trgDat.whitespaceState
			== TranslateRegularTest1LogicWriteData.STATE_WAS_SOMETHING_IN_LINE)
			writeSpace();
	...
	public void initGrammarFileWithPath(CommonInt32Array grammarFilePath) {
		...
		grmrDat = new TranslateRegularTest1GrammarData();
		grmrDat.init(dat);
	...
	public void initDocFileWithDirNode(
		...
		docDat = new TranslateRegularTest1DocData();
		docDat.init(dat);
	...
	private boolean walkSource() {
		TranslateRegularTest1TestDirInfo srcDirInfo
			= getTestDirInfoEntry(TranslateRegularTest1Data.SELECT_MAIN_SOURCE);

		TranslateRegularTest1TestDirInfo trgDirInfo
			= getTestDirInfoEntry(TranslateRegularTest1Data.SELECT_MAIN_TARGET);
		...
		if(srcDirInfo != null) {
			TranslateRegularTest1FileSelectInfo
			...
			if(!selectInfo.filesAll) {
				...
				dat.majorPassNum = TranslateRegularTest1Data.PASS_1_COLLECT_NAMES;
			...
			if(trgDirInfo != null) {
				dat.majorPassNum = TranslateRegularTest1Data.PASS_3_WRITE_LOGIC;
				dat.okTestFileCount = 0;
	...
	*/
	...
	public void addLogicFile(CommonInt32Array path) {
		TranslateRegularTest1TestDirInfo entry;
		TranslateRegularTest1FileSelectInfo selectInfo;
	...
	public TranslateRegularTest1TestDirInfo getTestDirInfoEntry(short flags) {
		...
		while(i < count) {
			entry = (TranslateRegularTest1TestDirInfo) testSelectList.get(i);
			
			if(FlagUtils.getFlagInt16(flags, TranslateRegularTest1Data.FLAG_TARGET)
				!= FlagUtils.getFlagInt16(entry.theFlags, TranslateRegularTest1Data.FLAG_TARGET))
			{
				i += 1;
				continue;
			}
			
			if(FlagUtils.getFlagInt16(flags, TranslateRegularTest1Data.FLAG_OUTSIDE)
				!= FlagUtils.getFlagInt16(entry.theFlags, TranslateRegularTest1Data.FLAG_OUTSIDE))
			{
				i += 1;
				continue;
			}

			if(FlagUtils.getFlagInt16(flags, TranslateRegularTest1Data.FLAG_CACHE)
				!= FlagUtils.getFlagInt16(entry.theFlags, TranslateRegularTest1Data.FLAG_CACHE))
			{
				i += 1;
				continue;
			}
	...
	public TranslateRegularTest1TestDirInfo createTestDirInfoEntry(short flags) {
		TranslateRegularTest1TestDirInfo entry;

		entry = new TranslateRegularTest1TestDirInfo();
	...
	private TranslateRegularTest1FileSelectInfo addFile(
		TranslateRegularTest1FileSelectInfo selectInfo, CommonInt32Array path) {
		
		TranslateRegularTest1FileSelectInfo selectInfo2;
		FileNode2 dirNode;
		FileNode2 fpNode;
		int fileType;
		...
		if(selectInfo2 == null) selectInfo2
			= new TranslateRegularTest1FileSelectInfo();
	...
	private TranslateRegularTest1FileSelectInfo addFilesAll(
		TranslateRegularTest1FileSelectInfo selectInfo) {
		...
		while(i < count) {
			...
			if(testStringEquals(arg, "--is-target")) {
				...
				if(testStringEquals(nextArg, "true")) {
					dat.testFlags = FlagUtils.setFlagInt16(
						dat.testFlags,
						TranslateRegularTest1Data.FLAG_TARGET,
						true);
					ok = true;
				}
			...
			if(testStringEquals(arg, "--is-outside")) {
				...
				if(testStringEquals(nextArg, "true")) {
					dat.testFlags = FlagUtils.setFlagInt16(
						dat.testFlags,
						TranslateRegularTest1Data.FLAG_OUTSIDE,
						true);
					ok = true;
				}
			...
			if(testStringEquals(arg, "--is-cache")) {
				...
				if(testStringEquals(nextArg, "true")) {
					dat.testFlags = FlagUtils.setFlagInt16(
						dat.testFlags,
						TranslateRegularTest1Data.FLAG_CACHE,
						true);
					ok = true;
				}
			...
			if(testStringEquals(arg, "--is-override")) {
				...
				if(testStringEquals(nextArg, "true")) {
					dat.testFlags = FlagUtils.setFlagInt16(
						dat.testFlags,
						TranslateRegularTest1Data.FLAG_OVERRIDE,
						true);
					ok = true;
				}
	...
	public static void main(String[] args) {
		TranslateRegularTest1 o = new TranslateRegularTest1();
		o.dat = new TranslateRegularTest1Data();
		o.out = System.out;
